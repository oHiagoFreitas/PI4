...
import Jogador from "./EditarJogador"; // Componente que renderiza cada jogador

function EditarCampoFutebol({ positions, openModal }) {
        ...
        <div className="campo-futebol">
            {positionData.map(position => (
                <Jogador
                    key={position.pos}
                    position={position}
                    nome={positions[position.pos] ? positions[position.pos].nome : ""} // Exibe o nome do jogador, se existir
...
export default EditarCampoFutebol;
